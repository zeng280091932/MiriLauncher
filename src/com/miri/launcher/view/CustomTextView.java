...
public class CustomTextView extends TextView {
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            //前景色
            if (a.hasValue(R.styleable.CustomTextView_foreground)) {
                Drawable foreground = a.getDrawable(R.styleable.CustomTextView_foreground);
                if (foreground != null) {
                    this.setForegroundDrawable(foreground);
                } else {
                    this.setTextColor(a.getColor(R.styleable.CustomTextView_foreground, 0xff000000));
                }
            }

            //背景色
            if (a.hasValue(R.styleable.CustomTextView_textBackground)) {
                Drawable background = a.getDrawable(R.styleable.CustomTextView_textBackground);
                if (background != null) {
                    this.setBackgroundDrawable(background);
                } else {
                    this.setBackgroundColor(a.getColor(R.styleable.CustomTextView_textBackground,
                            0xff000000));
                }
            }

            if (a.hasValue(R.styleable.CustomTextView_innerShadowColor)) {
                this.addInnerShadow(a.getFloat(R.styleable.CustomTextView_innerShadowRadius, 0),
                        a.getFloat(R.styleable.CustomTextView_innerShadowDx, 0),
                        a.getFloat(R.styleable.CustomTextView_innerShadowDy, 0),
                        a.getColor(R.styleable.CustomTextView_innerShadowColor, 0xff000000));
            }

            if (a.hasValue(R.styleable.CustomTextView_outerShadowColor)) {
                this.addOuterShadow(a.getFloat(R.styleable.CustomTextView_outerShadowRadius, 0),
                        a.getFloat(R.styleable.CustomTextView_outerShadowDx, 0),
                        a.getFloat(R.styleable.CustomTextView_outerShadowDy, 0),
                        a.getColor(R.styleable.CustomTextView_outerShadowColor, 0xff000000));
            }

            if (a.hasValue(R.styleable.CustomTextView_strokeColor)) {
                float strokeWidth = a.getFloat(R.styleable.CustomTextView_strokeWidth, 1);
                int strokeColor = a.getColor(R.styleable.CustomTextView_strokeColor, 0xff000000);
                float strokeMiter = a.getFloat(R.styleable.CustomTextView_strokeMiter, 10);
    ...
    public Drawable getForeground() {
        return this.foregroundDrawable == null ? this.foregroundDrawable : new ColorDrawable(
                this.getCurrentTextColor());
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (strokeColor != null) {
            ...
            //外描边(paint.setStrokeWidth(0);内描边)
