...
public class XmlUtils {
    ...
    public static final int convertValueToList(CharSequence value, String[] options,
            int defaultValue) {
        if (null != value) {
    ...
    /***
     * Flatten an object's value into an XmlSerializer. The value can later be read back with
     * readThisValueXml(). Currently supported value types are: null, String, Integer, Long, Float,
     * Double Boolean, Map, List.
     * @param v The object to be flattened.
     * @param name Name attribute to include with this value's tag, or null for none.
    ...
    /***
     * Read a HashMap from an InputStream containing XML. The stream can previously have been
     * written by writeMapXml().
     ...
     */
    public static final HashMap readMapXml(InputStream in) throws XmlPullParserException,
            java.io.IOException {
    ...
    /***
     * Read an ArrayList from an InputStream containing XML. The stream can previously have been
     * written by writeListXml().
     * @param in The InputStream from which to read.
     ...
     * @see #writeListXml
     */
    public static final ArrayList readListXml(InputStream in) throws XmlPullParserException,
            java.io.IOException {
        XmlPullParser parser = Xml.newPullParser();
        parser.setInput(in, null);
    ...
    /***
     * Read a HashSet from an InputStream containing XML. The stream can previously have been
     * written by writeSetXml().
     * @param in The InputStream from which to read.
     ...
     * @see #writeSetXml
     */
    public static final HashSet readSetXml(InputStream in) throws XmlPullParserException,
            java.io.IOException {
        XmlPullParser parser = Xml.newPullParser();
        parser.setInput(in, null);
    ...
    /***
     * Read a HashMap object from an XmlPullParser. The XML data could previously have been
     * generated by writeMapXml(). The XmlPullParser must be positioned <em>after</em> the tag that
     * begins the map.
     * @param parser The XmlPullParser from which to read the map data.
     * @param endTag Name of the tag that will end the map, usually "map".
     * @param name An array of one string, used to return the name attribute of the map's tag.
        ...
        do {
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (name[0] != null) {
                    ...
                    throw new XmlPullParserException("Map value without name attribute: "
                            + parser.getName());
                }
    ...
    /***
     * Read a HashSet object from an XmlPullParser. The XML data could previously have been
     * generated by writeSetXml(). The XmlPullParser must be positioned <em>after</em> the tag that
     * begins the set.
     * @param parser The XmlPullParser from which to read the set data.
     * @param endTag Name of the tag that will end the set, usually "set".
     * @param name An array of one string, used to return the name attribute of the set's tag.
    ...
    /***
     * Read an int[] object from an XmlPullParser. The XML data could previously have been generated
     * by writeIntArrayXml(). The XmlPullParser must be positioned <em>after</em> the tag that
     * begins the list.
     * @param parser The XmlPullParser from which to read the list data.
     * @param endTag Name of the tag that will end the list, usually "list".
     * @param name An array of one string, used to return the name attribute of the list's tag.
    ...
    /***
     * Read a flattened object from an XmlPullParser. The XML data could previously have been
     * written with writeMapXml(), writeListXml(), or writeValueXml(). The XmlPullParser must be
     * positioned <em>at</em> the tag that defines the value.
     * @param parser The XmlPullParser from which to read the object.
     * @param name An array of one string, used to return the name attribute of the value's tag.
    ...
    private static final Object readThisValueXml(XmlPullParser parser, String[] name)
        ...
        if (tagName.equals("null")) {
            ...
            while ((eventType = parser.next()) != XmlPullParser.END_DOCUMENT) {
                if (eventType == XmlPullParser.END_TAG) {
                    ...
                    throw new XmlPullParserException("Unexpected end tag in <string>: "
                            + parser.getName());
                } else if (eventType == XmlPullParser.TEXT) {
                    value += parser.getText();
                } else if (eventType == XmlPullParser.START_TAG) {
                    throw new XmlPullParserException("Unexpected start tag in <string>: "
                            + parser.getName());
                }
            }
        ...
        while ((eventType = parser.next()) != XmlPullParser.END_DOCUMENT) {
            if (eventType == XmlPullParser.END_TAG) {
                ...
                throw new XmlPullParserException("Unexpected end tag in <" + tagName + ">: "
                        + parser.getName());
            } else if (eventType == XmlPullParser.TEXT) {
                throw new XmlPullParserException("Unexpected text in <" + tagName + ">: "
                        + parser.getName());
            } else if (eventType == XmlPullParser.START_TAG) {
                throw new XmlPullParserException("Unexpected start tag in <" + tagName + ">: "
                        + parser.getName());
            }
        }
